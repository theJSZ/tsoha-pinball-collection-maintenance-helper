...
CREATE TABLE issues (id SERIAL PRIMARY KEY, machine_id INTEGER REFERENCES machines ON DELETE CASCADE, user_id INTEGER REFERENCES users, created_at TIMESTAMP, content TEXT, closed_by INTEGER REFERENCES users, severity INTEGER);
